 ...
 */
/**
 * //A Java class Sorter that inherits from the Runnable interface. Override and
 * implement the classes run() method //in which the thread runs every 5
 * milliseconds and sorts the array or similar data structure filled by the
 * Generator thread. //It must only attempt to perform the sort if the array is
 * of size 10 and has been freshly generated by the Generator thread. (1.5 pts)
 */
